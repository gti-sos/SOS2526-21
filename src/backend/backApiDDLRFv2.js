...
export function loadBackendApiDDLRFv2(app){
    ...
    app.post(BASE_URL_API + '/aids-deaths-stats', verifyToken, (req, res) => {
    ...
    //PUT 1 ELEMENTO
    app.put(BASE_URL_API + '/aids-deaths-stats/:codecountry/:year', verifyToken, (req, res) => {
    ...
    //REMOVE 1 ELEMENTO 
    app.delete(BASE_URL_API + '/aids-deaths-stats/:codecountry/:year', verifyToken, (req, res) => {
        db.find({"codecountry": req.params.codecountry, "year": parseInt(req.params.year,10)}, (err,muerte) =>
        {if(muerte.length == 0){ 
    ...
    //REMOVE TODOS
    app.delete(BASE_URL_API + '/aids-deaths-stats', verifyToken, (req, res) => {
